    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 sceneUVs = (i.projPos.xy / i.projPos.w) + lerp(((node_8362.rg*(node_3124*0.2))*_multiplier1),float2(0,0),saturate(pow((distance(i.posWorld.rgb,_WorldSpaceCameraPos)/_RefractionDistance),_RefractionFalloff)));
...
/////// Diffuse:
                ...
                float2 _remap = (((sceneUVs * 2 - 1).rg+(float2(_mask2.r,_mask2.g)*_Distortion))*0.5+0.5);
