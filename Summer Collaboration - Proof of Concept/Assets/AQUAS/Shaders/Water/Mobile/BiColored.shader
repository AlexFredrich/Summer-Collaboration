Shader "AQUAS/Mobile/Bicolored" {
    Properties {
        ...
        [MaterialToggle] _UseReflections ("Enable Reflections", Float ) = 0.07912221
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 _texture1 = tex2D(_NormalTexture,_multiplier2);
                float2 _multiplier1 = ((i.uv0+_multiplier3)*_division1);
                float4 _texture2 = tex2D(_NormalTexture,_multiplier1);
