    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 _texture1 = tex2D(_Normal,_multiplier2);
                float2 _multiplier3 = ((i.uv0+_multiplier4)*_division1);
                float4 _texture2 = tex2D(_Normal,_multiplier3);
...
/////// Diffuse:
                ...
                float4 _texture3 = tex2D(_FoamTexture,_multiplier6);
                float2 _multiplier5 = ((i.uv0+_multiplier7)*_division2);
                float4 _texture4 = tex2D(_FoamTexture,_multiplier5);
                float _value = 0.0;
